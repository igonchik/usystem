...
class Beacon(object):
    ...
    def list_beacons(self,
        ...
        evt.fire_event({'complete': True, 'beacons': beacons},
                       tag='/usystem/minion/minion_beacons_list_complete')
    ...
    def list_available_beacons(self):
        ...
        evt.fire_event({'complete': True, 'beacons': _beacons},
                       tag='/usystem/minion/minion_beacons_list_available_complete')
    ...
    def validate_beacon(self, name, beacon_data):
        ...
        evt.fire_event({'complete': True,
                        'vcomment': vcomment,
                        'valid': valid},
                       tag='/usystem/minion/minion_beacon_validation_complete')
    ...
    def add_beacon(self, name, beacon_data):
        ...
        evt.fire_event({'complete': complete, 'comment': comment,
                       ...
                       tag='/usystem/minion/minion_beacon_add_complete')
    ...
    def modify_beacon(self, name, beacon_data):
        ...
        evt.fire_event({'complete': complete, 'comment': comment,
                        'beacons': self.opts['beacons']},
                       tag='/usystem/minion/minion_beacon_modify_complete')
        return True
    ...
    def delete_beacon(self, name):
        ...
        evt.fire_event({'complete': complete, 'comment': comment,
                        'beacons': self.opts['beacons']},
                       tag='/usystem/minion/minion_beacon_delete_complete')
    ...
    def enable_beacons(self):
        ...
        evt.fire_event({'complete': True, 'beacons': self.opts['beacons']},
                       tag='/usystem/minion/minion_beacons_enabled_complete')
    ...
    def disable_beacons(self):
        ...
        evt = salt.utils.event.get_event('minion', opts=self.opts)
        evt.fire_event({'complete': True, 'beacons': self.opts['beacons']},
                       tag='/usystem/minion/minion_beacons_disabled_complete')
    ...
    def enable_beacon(self, name):
        ...
        evt.fire_event({'complete': complete, 'comment': comment,
                        'beacons': self.opts['beacons']},
                       tag='/usystem/minion/minion_beacon_enabled_complete')
    ...
    def disable_beacon(self, name):
        ...
        evt.fire_event({'complete': complete, 'comment': comment,
                        'beacons': self.opts['beacons']},
                       tag='/usystem/minion/minion_beacon_disabled_complete')
