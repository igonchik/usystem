...
Example ``/etc/usystem/cloud.providers`` or
``/etc/usystem/cloud.providers.d/azure.conf`` configuration:
...
.. code-block:: yaml
    ...
    my-azure-config:
      ...
      certificate_path: /etc/usystem/azure.pem
...
def put_blob(kwargs=None, storage_conn=None, call=None):
    ...
    .. code-block:: bash
        ...
        salt-cloud -f put_blob my-azure container=base name=top.sls blob_path=/srv/usystem/top.sls
...
def get_blob(kwargs=None, storage_conn=None, call=None):
    ...
    .. code-block:: bash
        ...
        salt-cloud -f get_blob my-azure container=base name=top.sls local_path=/srv/usystem/top.sls
