...
Set up the cloud configuration at ``/etc/usystem/cloud.providers`` or
``/etc/usystem/cloud.providers.d/vultr.conf``:
...
Set up the cloud profile at ``/etc/usystem/cloud.profiles`` or
``/etc/usystem/cloud.profiles.d/vultr.conf``:
