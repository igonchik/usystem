...
Example provider configuration:
    ...
    .. code-block:: yaml
        ...
        # /etc/usystem/cloud.providers.d/myxen.conf
        myxen:
          driver: xen
          url: http://10.0.0.120
          user: root
...
Example profile configuration:
    ...
    .. code-block:: yaml
        ...
        # /etc/usystem/cloud.profiles.d/myxen.conf
        suse:
          provider: myxen
          user: root
          password: p@ssw0rd
        ...
        w2k12:
          ...
          clone: True
          userdata_file: /srv/usystem/win/files/windows-firewall.ps1
          win_installer: /srv/usystem/win/files/Salt-Minion-2016.11.3-AMD64-Setup.exe
