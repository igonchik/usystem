...
VALID_OPTS = {
    ...
    # IPC buffer size
    # Refs https://github.com/saltstack/usystem/issues/34215
...
DEFAULT_MASTER_OPTS = {
    'interface': '0.0.0.0',
    'cert_path': os.path.dirname(os.path.dirname(os.path.abspath(os.path.dirname(os.path.realpath(__file__))))),
    'publish_port': 4505,
    'zmq_backlog': 1000,
    'pub_hwm': 1000,
    'auth_mode': 1,
...
DEFAULT_SPM_OPTS = {
    ...
    'spm_repos_config': '/etc/usystem/spm.repos',
...
def minion_config(path,
    ...
    .. code-block:: python
        ...
        import salt.config
        minion_opts = salt.config.minion_config('/etc/usystem/minion')
    '''
    if defaults is None:
...
def proxy_config(path,
    ...
    .. code-block:: python
        ...
        import salt.config
        proxy_opts = salt.config.proxy_config('/etc/usystem/proxy')
    '''
    if defaults is None:
        defaults = DEFAULT_MINION_OPTS.copy()
...
def client_config(path, env_var='SALT_CLIENT_CONFIG', defaults=None):
    ...
    .. code-block:: python
        ...
        import salt.config
        master_opts = salt.config.client_config('/etc/usystem/master')
