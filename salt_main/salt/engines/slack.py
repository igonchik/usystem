...
class SlackClient(object):
    ...
    def get_slack_channels(self, token):
        ...
        ret = salt.utils.slack.query(
            function='rooms',
            api_key=token,
            # These won't be honored until https://github.com/saltstack/usystem/pull/41187/files is merged
            opts={
...
# obviously pass in
    ...
    def get_jobs_from_runner(self, outstanding_jids):
        ...
        '''
        # Can't use the runner because of https://github.com/saltstack/usystem/issues/40671
