...
def list_(return_yaml=True,
    ...
    try:
        ...
        res = __salt__['event.fire']({'func': 'list',
                                     ...
                                     'manage_beacons')
        if res:
            event_ret = eventer.get_event(tag='/usystem/minion/minion_beacons_list_complete', wait=30)
...
def list_available(return_yaml=True):
    ...
    try:
        ...
        if res:
            event_ret = eventer.get_event(tag='/usystem/minion/minion_beacons_list_available_complete', wait=30)
            if event_ret and event_ret['complete']:
                beacons = event_ret['beacons']
    except KeyError:
        # Effectively a no-op, since we can't really return without an event system
    ...
    if 'test' in kwargs and kwargs['test']:
        ...
        try:
            ...
            res = __salt__['event.fire']({'name': name,
                                         ...
                                         'manage_beacons')
            if res:
                event_ret = eventer.get_event(tag='/usystem/minion/minion_beacon_validation_complete', wait=30)
        ...
        try:
            ...
            if res:
                event_ret = eventer.get_event(tag='/usystem/minion/minion_beacon_add_complete', wait=30)
                if event_ret and event_ret['complete']:
                    beacons = event_ret['beacons']
...
def modify(name, beacon_data, **kwargs):
    ...
    if 'test' in kwargs and kwargs['test']:
        ...
        try:
            ...
            if res:
                event_ret = eventer.get_event(tag='/usystem/minion/minion_beacon_modify_complete', wait=30)
                if event_ret and event_ret['complete']:
                    beacons = event_ret['beacons']
                    if name in beacons and beacons[name] == beacon_data:
                        ret['result'] = True
...
def delete(name, **kwargs):
    ...
    if 'test' in kwargs and kwargs['test']:
        ...
        try:
            ...
            if res:
                event_ret = eventer.get_event(tag='/usystem/minion/minion_beacon_delete_complete', wait=30)
                if event_ret and event_ret['complete']:
                    beacons = event_ret['beacons']
...
def enable(**kwargs):
    ...
    if 'test' in kwargs and kwargs['test']:
        ...
        try:
            ...
            if res:
                event_ret = eventer.get_event(tag='/usystem/minion/minion_beacons_enabled_complete', wait=30)
                if event_ret and event_ret['complete']:
                    beacons = event_ret['beacons']
...
def disable(**kwargs):
    ...
    if 'test' in kwargs and kwargs['test']:
        ...
        try:
            ...
            if res:
                event_ret = eventer.get_event(tag='/usystem/minion/minion_beacons_disabled_complete', wait=30)
                log.debug('event_ret %s', event_ret)
                if event_ret and event_ret['complete']:
                    beacons = event_ret['beacons']
...
def enable_beacon(name, **kwargs):
    ...
    if 'test' in kwargs and kwargs['test']:
        ...
        try:
            ...
            if res:
                event_ret = eventer.get_event(tag='/usystem/minion/minion_beacon_enabled_complete', wait=30)
                if event_ret and event_ret['complete']:
                    beacons = event_ret['beacons']
...
def disable_beacon(name, **kwargs):
    ...
    if 'test' in kwargs and kwargs['test']:
        ...
        try:
            ...
            if res:
                event_ret = eventer.get_event(tag='/usystem/minion/minion_beacon_disabled_complete', wait=30)
                if event_ret and event_ret['complete']:
                    beacons = event_ret['beacons']
                    beacon_config_dict = _get_beacon_config_dict(beacons[name])
