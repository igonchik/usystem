...
.. code-block:: bash
    ...
    salt '*' kubernetes.nodes kubeconfig=/etc/usystem/k8s/kubeconfig context=minikube
...
def namespaces(**kwargs):
    ...
    CLI Examples::
        ...
        salt '*' kubernetes.namespaces kubeconfig=/etc/usystem/k8s/kubeconfig context=minikube
    '''
    cfg = _setup_conn(**kwargs)
    try:
        api_instance = kubernetes.client.CoreV1Api()
