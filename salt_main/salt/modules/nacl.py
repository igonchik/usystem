...
:configuration: The following configuration defaults can be
    ...
    .. code-block:: python
        ...
        # cat /etc/usystem/master.d/nacl.conf
        nacl.config:
            ...
            sk_file: /etc/usystem/pki/master/nacl      (default)
            pk_file: /etc/usystem/pki/master/nacl.pub  (default)
            sk: None
            pk: None
    ...
    .. code-block:: bash
        ...
        salt-call nacl.enc sk_file=/etc/usystem/pki/master/nacl pk_file=/etc/usystem/pki/master/nacl.pub
...
.. code-block:: bash
    ...
    salt-call --local nacl.keygen sk_file=/etc/usystem/pki/master/nacl
...
.. code-block:: python
    ...
    # cat /etc/usystem/master.d/nacl.conf
    nacl.config:
        sk_file: /etc/usystem/pki/master/nacl
...
.. code-block:: jinja
    ...
    pillarexample:
        ...
        cert_key: {{salt.nacl.dec_file('/srv/usystem/certs/example.com/key.nacl')|json}}
...
def keygen(sk_file=None, pk_file=None, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call nacl.keygen sk_file=/etc/usystem/pki/master/nacl
        salt-call nacl.keygen sk_file=/etc/usystem/pki/master/nacl pk_file=/etc/usystem/pki/master/nacl.pub
        salt-call --local nacl.keygen
    '''
...
def enc_file(name, out=None, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-run nacl.enc_file name=/tmp/id_rsa box_type=secretbox \
            sk_file=/etc/usystem/pki/master/nacl.pub
    '''
    kwargs['opts'] = __opts__
...
def sealedbox_encrypt(data, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call --local nacl.sealedbox_encrypt datatoenc pk_file=/etc/usystem/pki/master/nacl.pub
...
def sealedbox_decrypt(data, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call --local nacl.sealedbox_decrypt data='pEXHQM6cuaF7A=' sk_file=/etc/usystem/pki/master/nacl
...
def secretbox_encrypt(data, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call --local nacl.secretbox_encrypt datatoenc sk_file=/etc/usystem/pki/master/nacl
...
def secretbox_decrypt(data, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-call --local nacl.secretbox_decrypt data='pEXHQM6cuaF7A=' sk_file=/etc/usystem/pki/master/nacl
