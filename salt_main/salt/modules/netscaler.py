...
:configuration: This module accepts connection configuration details either as
    parameters, or as configuration settings in /etc/usystem/minion on the relevant
    minions
...
:CLI Examples:
    Calls relying on configuration passed using /etc/usystem/minion, grains, or pillars:
    .. code-block:: bash
