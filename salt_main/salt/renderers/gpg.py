...
.. code-block:: bash
    ...
    # mkdir -p /etc/usystem/gpgkeys
    # chmod 0700 /etc/usystem/gpgkeys
    # gpg --gen-key --homedir /etc/usystem/gpgkeys
...
.. code-block:: bash
    ...
    # gpg --homedir /etc/usystem/gpgkeys --armor --export <KEY-NAME> > exported_pubkey.gpg
