...
.. code-block:: yaml
    ...
    sqlite3.database: /usr/lib/usystem/salt.db
    sqlite3.timeout: 5.0
...
.. code-block:: yaml
    ...
    alternative.sqlite3.database: /usr/lib/usystem/salt.db
...
.. code-block:: sql
    ...
    sqlite3 /usr/lib/usystem/salt.db << EOF
    --
...
.. code-block:: bash
    ...
    salt '*' test.ping --return sqlite3 --return_kwargs '{"db": "/var/lib/usystem/another-salt.db"}'
