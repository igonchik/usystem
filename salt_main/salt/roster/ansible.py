...
.. code-block:: bash
    ...
    [~]# salt-ssh --roster-file /etc/usystem/hosts salt.gtmanfred.com test.ping
    salt.gtmanfred.com:
            True
...
class Inventory(Target):
    ...
    '''
    def __init__(self, tgt, tgt_type='glob', inventory_file='/etc/usystem/roster'):
        self.tgt = tgt
