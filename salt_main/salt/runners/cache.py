...
def list_(bank, cachedir=None):
    ...
    .. code-block:: bash
        ...
        salt-run cache.list cloud/active/ec2/myec2 cachedir=/var/cache/usystem/
    '''
    if cachedir is None:
        cachedir = __opts__['cachedir']
...
def fetch(bank, key, cachedir=None):
    ...
    .. code-block:: bash
        ...
        salt-run cache.fetch cloud/active/ec2/myec2 myminion cachedir=/var/cache/usystem/
    '''
    if cachedir is None:
        cachedir = __opts__['cachedir']
...
def flush(bank, key=None, cachedir=None):
    ...
    .. code-block:: bash
        ...
        salt-run cache.flush cloud/active/ec2/myec2 cachedir=/var/cache/usystem/
        salt-run cache.flush cloud/active/ec2/myec2 myminion cachedir=/var/cache/usystem/
    '''
    if cachedir is None:
        cachedir = __opts__['cachedir']
