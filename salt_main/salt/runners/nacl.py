...
:configuration: The following configuration defaults can be
    ...
    .. code-block:: bash
        ...
        salt-run nacl.enc sk_file=/etc/usystem/pki/master/nacl pk_file=/etc/usystem/pki/master/nacl.pub
...
.. code-block:: bash
    ...
    salt-run nacl.keygen sk_file=/etc/usystem/pki/master/nacl
...
def keygen(sk_file=None, pk_file=None, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-run nacl.keygen
        salt-run nacl.keygen sk_file=/etc/usystem/pki/master/nacl
        salt-run nacl.keygen sk_file=/etc/usystem/pki/master/nacl pk_file=/etc/usystem/pki/master/nacl.pub
        salt-run nacl.keygen
    '''
...
def sealedbox_decrypt(data, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-run nacl.sealedbox_decrypt data='pEXHQM6cuaF7A=' sk_file=/etc/usystem/pki/master/nacl
...
def secretbox_encrypt(data, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-run nacl.secretbox_encrypt datatoenc sk_file=/etc/usystem/pki/master/nacl
...
def secretbox_decrypt(data, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-run nacl.secretbox_decrypt data='pEXHQM6cuaF7A=' sk_file=/etc/usystem/pki/master/nacl
