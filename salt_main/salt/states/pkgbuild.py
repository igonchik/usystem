...
.. code-block:: yaml
    ...
    salt_2015.5.2:
      pkgbuild.built:
        ...
        - dest_dir: /tmp/pkg
        - spec: salt://pkg/usystem/spec/salt.spec
        - template: jinja
        - deps:
          - salt://pkg/usystem/sources/required_dependency.rpm
        - tgt: epel-7-x86_64
        - sources:
          - salt://pkg/usystem/sources/logrotate.salt
          - salt://pkg/usystem/sources/README.fedora
          - salt://pkg/usystem/sources/salt-2015.5.2.tar.gz
          - salt://pkg/usystem/sources/salt-2015.5.2-tests.patch
          - salt://pkg/usystem/sources/salt-api
          - salt://pkg/usystem/sources/salt-api.service
          - salt://pkg/usystem/sources/salt-master
          - salt://pkg/usystem/sources/salt-master.service
          - salt://pkg/usystem/sources/salt-minion
          - salt://pkg/usystem/sources/salt-minion.service
          - salt://pkg/usystem/sources/saltpkg.sls
          - salt://pkg/usystem/sources/salt-syndic
          - salt://pkg/usystem/sources/salt-syndic.service
          - salt://pkg/usystem/sources/SaltTesting-2015.5.8.tar.gz
    /tmp/pkg:
      pkgbuild.repo
'''
# Import python libs
...
def built(name,
          ...
          force=False,
          saltenv='base',
          log_dir='/var/log/usystem/pkgbuild'):
    '''
    ...
    log_dir : /var/log/usystem/rpmbuild
