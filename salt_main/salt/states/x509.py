...
/etc/usystem/master.d/peer.conf
...
.. code-block:: yaml
    ...
    salt-minion:
      service.running:
        - enable: True
        - listen:
          - file: /etc/usystem/minion.d/signing_policies.conf

    /etc/usystem/minion.d/signing_policies.conf:
      file.managed:
...
/srv/usystem/signing_policies.conf
