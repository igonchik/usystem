...
class Schedule(object):
    ...
    def delete_job(self, name, persist=True):
        ...
        evt.fire_event({'complete': True,
                       ...
                       tag='/usystem/minion/minion_schedule_delete_complete')
    ...
    def add_job(self, data, persist=True):
        ...
        evt.fire_event({'complete': True,
                        'schedule': self._get_schedule()},
                       tag='/usystem/minion/minion_schedule_add_complete')
    ...
    def enable_job(self, name, persist=True):
        ...
        evt.fire_event({'complete': True,
                        'schedule': self._get_schedule()},
                       tag='/usystem/minion/minion_schedule_enabled_job_complete')
    ...
    def disable_job(self, name, persist=True):
        ...
        evt.fire_event({'complete': True,
                        'schedule': self._get_schedule()},
                       tag='/usystem/minion/minion_schedule_disabled_job_complete')
    ...
    def enable_schedule(self):
        ...
        evt.fire_event({'complete': True, 'schedule': self._get_schedule()},
                       tag='/usystem/minion/minion_schedule_enabled_complete')
    ...
    def disable_schedule(self):
        ...
        evt = salt.utils.event.get_event('minion', opts=self.opts, listen=False)
        evt.fire_event({'complete': True, 'schedule': self._get_schedule()},
                       tag='/usystem/minion/minion_schedule_disabled_complete')
    ...
    def list(self, where):
        ...
        evt.fire_event({'complete': True, 'schedule': schedule},
                       tag='/usystem/minion/minion_schedule_list_complete')
    ...
    def save_schedule(self):
        ...
        evt = salt.utils.event.get_event('minion', opts=self.opts, listen=False)
        evt.fire_event({'complete': True},
                       tag='/usystem/minion/minion_schedule_saved')
    ...
    def postpone_job(self, name, data):
        ...
        evt.fire_event({'complete': True,
                        'schedule': self._get_schedule()},
                       tag='/usystem/minion/minion_schedule_postpone_job_complete')
    ...
    def skip_job(self, name, data):
        ...
        evt.fire_event({'complete': True,
                        'schedule': self._get_schedule()},
                       tag='/usystem/minion/minion_schedule_skip_job_complete')
    ...
    def get_next_fire_time(self, name, fmt='%Y-%m-%dT%H:%M:%S'):
        ...
        evt.fire_event({'complete': True, 'next_fire_time': _next_fire_time},
                       tag='/usystem/minion/minion_schedule_next_fire_time_complete')
        ...
        try:
            ...
            if not self.standalone:
                if 'jid_include' not in data or data['jid_include']:
                    ...
                    # write this to /var/cache/usystem/minion/proc
...
def clean_proc_dir(opts):
    ...
    '''
    Loop through jid files in the minion proc directory (default /var/cache/usystem/minion/proc)
